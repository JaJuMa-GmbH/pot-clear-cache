# :broom: Clear Cache Power Toy for Magento 2 by [JaJuMa](https://www.jajuma.de/)

<img align="right" width="35%" height="auto" src="https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-magento/JaJuMa-Clear-Cache-Power-Toy-For-Magento-2-small.png">  

Clear Cache Power Toy for Magento 2 by [JaJuMa](https://www.jajuma.de/en) is a quick action toy 
that enables flushing Magento cache quickly and conveniently with Pacman power.
...
* Cache Status indicator:
   * red circle: Cache(s) are disabled/invalidated
   * green circle: Cache(s) are enabled & up-to-date
* Clear Cache with a simple click from Power Toys panel
...
<td>
    <table>
     <tr>
        <td><b>Clear Cache Toy</b><br>Dark Mode</td>
        <td><b>Clear Cache Toy</b><br>Light Mode</td>
     </tr>
     <tr>
       <td><img src="https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-magento/screenshots/Magento-Clear-Cache-Power-Toy-Dark.jpg"></td>
       <td><img src="https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-magento/screenshots/Magento-Clear-Cache-Power-Toy-Light.jpg"></td>
    </tr>
    </table>
</td>
...
## Using Clear Cache Power Toy For Magento

After installing this module:  
Go to   
**JaJuMa -> Power Toys -> Configuration**  
and enable & configure Clear Cache Toy.
...
displaying the Clear Cache Toy.
A click on Clear Cache Toy will flush your Magento caches.

* [See Manual for more details](https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-magento/manuals/JaJuMa_Clear_Cache_Power_Toy_Manual_v001.pdf)


## License

The code is licensed under the [MIT License (MIT)](https://github.com/JaJuMa/pot-clear-cache/blob/master/LICENSE)
